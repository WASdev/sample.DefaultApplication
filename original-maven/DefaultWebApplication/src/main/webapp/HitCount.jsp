...
<%= selection.equals("EJB") ? " CHECKED" : "" %> onClick="if (this.checked) {enableLookupButtons();enableTransButtons()}">Enterprise Java Bean (CMP)</BR>
</BR><B>Namespace lookup method for EJB:</B></BR>
<INPUT TYPE=RADIO NAME=lookup VALUE=GBL
<%= lookup.equals("GBL") ? " CHECKED" : "" %>>Global Namespace
<INPUT TYPE=RADIO NAME=lookup VALUE=LCL
<%= lookup.equals("LCL") ? " CHECKED" : "" %>>Local Namespace</BR>
